...
typedef TextMapper3 = String Function(String numberText);

class NumberPicker3 extends StatefulWidget {
  ...
  @override
  _NumberPicker3State createState() => _NumberPicker3State();
}

class _NumberPicker3State extends State<NumberPicker3> {
  ...
  @override
  void didUpdateWidget(NumberPicker3 oldWidget) {
      ...
      child: NotificationListener<ScrollEndNotification>(
        ...
        child: Stack(
          children: [
            ...
            _NumberPicker3SelectedItemDecoration(
              axis: widget.axis,
              itemExtent: itemExtent,
  ...
  Widget _itemBuilder(BuildContext context, int index) {
    ...
    final mainitem = value == widget.value;
    var child;
    if (mainitem) {
      child = isExtra
          ? SizedBox.shrink()
  ...
  String _getDisplayedValue(int value) {
    final text = widget.zeroPad
        ...
        : value.toString();
    if (widget.textMapper3 != null) {
      return widget.textMapper3!(text);
    } else {
      return text;
    }
  }
...
class _NumberPicker3SelectedItemDecoration extends StatelessWidget {
  final Axis axis;
  final double itemExtent;
  final Decoration? decoration;

  const _NumberPicker3SelectedItemDecoration({
    Key? key,
    required this.axis,
