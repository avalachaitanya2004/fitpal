...
typedef TextMapper2 = String Function(String numberText);
...
class NumberPicker2 extends StatefulWidget {
  ...
  @override
  _NumberPicker2State createState() => _NumberPicker2State();
}

class _NumberPicker2State extends State<NumberPicker2> {
  ...
  @override
  void didUpdateWidget(NumberPicker2 oldWidget) {
      ...
      child: NotificationListener<ScrollEndNotification>(
        ...
        child: Stack(
          children: [
            ...
            _NumberPicker2SelectedItemDecoration(
              axis: widget.axis,
              itemExtent: itemExtent,
  ...
  String _getDisplayedValue(int value) {
    final text = widget.zeroPad
        ...
        : value.toString();
    if (widget.textMapper2 != null) {
      return widget.textMapper2!(text);
    } else {
      return text;
    }
  }
...
class _NumberPicker2SelectedItemDecoration extends StatelessWidget {
  final Axis axis;
  final double itemExtent;
  final Decoration? decoration;

  const _NumberPicker2SelectedItemDecoration({
    Key? key,
    required this.axis,
